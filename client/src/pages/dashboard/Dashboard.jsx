...
export default function Dashboard() {
    ...
    return (
        <div className="flex-col mx-auto mt-5">
            <section
                id="monthly-client-report"
                className="flex-col border p-3 rounded-lg mt-5 w-[60%]"
            >
            ...
            {/* Material-UI DataGrid for clients */}
            <section
                id="past-clients-report"
                className="border p-3 rounded-lg mt-5 w-[60%]"
            >
                ...
                <>
                    <input
                        ...
                        placeholder="Search..."
                        className="px-2 py-1 border rounded-md focus:outline-none focus:ring focus:ring-blue-300"
                    />
                    <DataGrid
                        autoHeight
